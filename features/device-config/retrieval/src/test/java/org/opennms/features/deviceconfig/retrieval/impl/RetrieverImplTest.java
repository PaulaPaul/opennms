...
public class RetrieverImplTest {
    ...
    public void shouldRetrieveConfiguration() throws Exception {
        ...
        when(sshScriptingService.execute(any(), any(), any(), any(), any(), any(), null, varsCaptor.capture(), any())).thenReturn(SshScriptingService.Result.success("Success"));
    ...
    public void shouldHandleScriptingExceptions() throws Exception {
        ...
        when(sshScriptingService.execute(any(), any(), any(), any(), any(), any(), null, any(), any())).thenThrow(scriptingException);
        doNothing().when(tftpServer).register(receiverCaptor.capture());
    ...
    public void shouldHandleScriptingFailures() throws Exception {
        ...
        when(sshScriptingService.execute(any(), any(), any(), any(), any(), any(), null, any(), any())).thenReturn(SshScriptingService.Result.failure(scriptingFailureMessage));
        doNothing().when(tftpServer).register(receiverCaptor.capture());
    ...
    public void shouldHandleTimeouts() throws Exception {
        ...
        var tftpServer = mock(TftpServer.class);
        var receiverCaptor = ArgumentCaptor.forClass(TftpFileReceiver.class);
        when(sshScriptingService.execute(any(), any(), any(), any(), any(), any(), null, any(), any())).thenReturn(SshScriptingService.Result.success("Success"));
        doNothing().when(tftpServer).register(receiverCaptor.capture());
